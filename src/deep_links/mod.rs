...
pub struct ExternalPlayerLink {
    ...
    pub choose: Option<OpenPlayerLink>,
    pub outplayer: Option<OpenPlayerLink>,
    pub infuse: Option<OpenPlayerLink>,
    pub mxplayer: Option<OpenPlayerLink>,
    pub justplayer: Option<OpenPlayerLink>,
