...
/// Add-on specific properties survive deserialization.
#[test]
...
/// A subtitle with no extra properties round-trips unchanged.
#[test]
...
/// The extra properties are serialized back out.
#[test]
